...
setblock ~ ~ ~ minecraft:green_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:green_bed[occupied=false,facing=south,part=foot] replace
