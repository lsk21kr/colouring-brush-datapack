...
setblock ~ ~ ~ minecraft:light_gray_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:light_gray_bed[occupied=false,facing=south,part=foot] replace
