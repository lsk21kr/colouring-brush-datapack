...
setblock ~ ~ ~ minecraft:magenta_bed[occupied=false,facing=east,part=head] replace
setblock ~-1 ~ ~ minecraft:magenta_bed[occupied=false,facing=east,part=foot] replace
