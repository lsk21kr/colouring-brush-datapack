...
setblock ~ ~ ~ minecraft:magenta_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:magenta_bed[occupied=false,facing=south,part=foot] replace
