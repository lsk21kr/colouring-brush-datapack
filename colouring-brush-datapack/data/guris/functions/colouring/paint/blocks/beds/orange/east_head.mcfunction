...
setblock ~ ~ ~ minecraft:orange_bed[occupied=false,facing=east,part=head] replace
setblock ~-1 ~ ~ minecraft:orange_bed[occupied=false,facing=east,part=foot] replace
