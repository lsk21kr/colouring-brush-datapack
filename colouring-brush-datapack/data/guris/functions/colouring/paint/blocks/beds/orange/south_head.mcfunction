...
setblock ~ ~ ~ minecraft:orange_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:orange_bed[occupied=false,facing=south,part=foot] replace
