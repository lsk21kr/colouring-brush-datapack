...
setblock ~ ~ ~ minecraft:purple_bed[occupied=false,facing=east,part=head] replace
setblock ~-1 ~ ~ minecraft:purple_bed[occupied=false,facing=east,part=foot] replace
