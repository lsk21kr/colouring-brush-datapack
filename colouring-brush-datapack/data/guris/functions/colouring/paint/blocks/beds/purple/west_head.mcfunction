...
setblock ~ ~ ~ minecraft:purple_bed[occupied=false,facing=west,part=head] replace
setblock ~1 ~ ~ minecraft:purple_bed[occupied=false,facing=west,part=foot] replace
