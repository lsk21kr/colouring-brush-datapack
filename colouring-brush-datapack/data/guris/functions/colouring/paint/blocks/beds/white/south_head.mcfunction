...
setblock ~ ~ ~ minecraft:white_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:white_bed[occupied=false,facing=south,part=foot] replace
