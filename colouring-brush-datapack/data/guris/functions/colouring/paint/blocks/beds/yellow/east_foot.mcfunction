...
setblock ~ ~ ~ minecraft:yellow_bed[occupied=false,facing=east,part=foot] replace
setblock ~1 ~ ~ minecraft:yellow_bed[occupied=false,facing=east,part=head] replace
