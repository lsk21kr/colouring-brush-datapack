...
setblock ~ ~ ~ minecraft:yellow_bed[occupied=false,facing=west,part=foot] replace
setblock ~-1 ~ ~ minecraft:yellow_bed[occupied=false,facing=west,part=head] replace
