...
setblock ~ ~ ~ minecraft:black_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:black_bed[occupied=false,facing=south,part=foot] replace
