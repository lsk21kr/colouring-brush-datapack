...
setblock ~ ~ ~ minecraft:brown_bed[occupied=false,facing=south,part=foot] replace
setblock ~ ~ ~1 minecraft:brown_bed[occupied=false,facing=south,part=head] replace
