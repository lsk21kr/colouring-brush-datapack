...
setblock ~ ~ ~ minecraft:light_blue_bed[occupied=false,facing=north,part=head] replace
setblock ~ ~ ~1 minecraft:light_blue_bed[occupied=false,facing=north,part=foot] replace
