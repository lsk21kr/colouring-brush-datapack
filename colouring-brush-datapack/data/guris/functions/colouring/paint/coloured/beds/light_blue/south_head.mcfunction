...
setblock ~ ~ ~ minecraft:light_blue_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:light_blue_bed[occupied=false,facing=south,part=foot] replace
