...
setblock ~ ~ ~ minecraft:light_gray_bed[occupied=false,facing=west,part=foot] replace
setblock ~-1 ~ ~ minecraft:light_gray_bed[occupied=false,facing=west,part=head] replace
