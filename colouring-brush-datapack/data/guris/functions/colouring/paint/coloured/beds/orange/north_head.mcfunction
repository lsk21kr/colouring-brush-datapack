...
setblock ~ ~ ~ minecraft:orange_bed[occupied=false,facing=north,part=head] replace
setblock ~ ~ ~1 minecraft:orange_bed[occupied=false,facing=north,part=foot] replace
