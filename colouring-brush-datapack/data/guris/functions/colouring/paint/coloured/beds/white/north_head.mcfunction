...
setblock ~ ~ ~ minecraft:white_bed[occupied=false,facing=north,part=head] replace
setblock ~ ~ ~1 minecraft:white_bed[occupied=false,facing=north,part=foot] replace
