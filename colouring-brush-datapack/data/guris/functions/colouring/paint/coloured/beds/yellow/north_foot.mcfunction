...
setblock ~ ~ ~ minecraft:yellow_bed[occupied=false,facing=north,part=foot] replace
setblock ~ ~ ~-1 minecraft:yellow_bed[occupied=false,facing=north,part=head] replace
