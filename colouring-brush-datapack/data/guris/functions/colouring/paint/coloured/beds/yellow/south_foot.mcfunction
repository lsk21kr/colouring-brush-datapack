...
setblock ~ ~ ~ minecraft:yellow_bed[occupied=false,facing=south,part=foot] replace
setblock ~ ~ ~1 minecraft:yellow_bed[occupied=false,facing=south,part=head] replace
