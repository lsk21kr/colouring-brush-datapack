...
execute if predicate guris:colouring/dyes/brown unless block ~ ~ ~ #guris:colouring/wooden/jungle_blocks run function guris:colouring/paint/wooden/fences/jungle
...
execute if predicate guris:colouring/dyes/purple unless block ~ ~ ~ minecraft:nether_brick_fence run function guris:colouring/paint/wooden/fences/nether_brick