...
execute unless score option_green_jungle guris.colouring matches 1 if predicate guris:colouring/dyes/brown unless block ~ ~ ~ #guris:colouring/wooden/jungle_blocks run function guris:colouring/paint/wooden/wall_signs/jungle
execute if score option_green_jungle guris.colouring matches 1 if predicate guris:colouring/dyes/green unless block ~ ~ ~ #guris:colouring/wooden/jungle_blocks run function guris:colouring/paint/wooden/wall_signs/jungle
