...
setblock ~ ~ ~ minecraft:black_bed[occupied=false,facing=north,part=foot] replace
setblock ~ ~ ~-1 minecraft:black_bed[occupied=false,facing=north,part=head] replace
