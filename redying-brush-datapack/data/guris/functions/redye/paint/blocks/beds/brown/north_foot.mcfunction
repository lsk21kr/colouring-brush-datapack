...
setblock ~ ~ ~ minecraft:brown_bed[occupied=false,facing=north,part=foot] replace
setblock ~ ~ ~-1 minecraft:brown_bed[occupied=false,facing=north,part=head] replace
