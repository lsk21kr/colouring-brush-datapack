...
setblock ~ ~ ~ minecraft:green_bed[occupied=false,facing=north,part=foot] replace
setblock ~ ~ ~-1 minecraft:green_bed[occupied=false,facing=north,part=head] replace
