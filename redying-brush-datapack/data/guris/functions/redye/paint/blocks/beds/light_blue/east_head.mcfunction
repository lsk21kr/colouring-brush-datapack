...
setblock ~ ~ ~ minecraft:light_blue_bed[occupied=false,facing=east,part=head] replace
setblock ~-1 ~ ~ minecraft:light_blue_bed[occupied=false,facing=east,part=foot] replace
