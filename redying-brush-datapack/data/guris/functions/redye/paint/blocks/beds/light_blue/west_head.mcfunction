...
setblock ~ ~ ~ minecraft:light_blue_bed[occupied=false,facing=west,part=head] replace
setblock ~1 ~ ~ minecraft:light_blue_bed[occupied=false,facing=west,part=foot] replace
