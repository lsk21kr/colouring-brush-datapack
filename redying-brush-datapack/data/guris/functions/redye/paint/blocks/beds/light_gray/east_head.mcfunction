...
setblock ~ ~ ~ minecraft:light_gray_bed[occupied=false,facing=east,part=head] replace
setblock ~-1 ~ ~ minecraft:light_gray_bed[occupied=false,facing=east,part=foot] replace
