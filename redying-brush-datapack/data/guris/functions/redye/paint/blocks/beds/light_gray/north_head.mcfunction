...
setblock ~ ~ ~ minecraft:light_gray_bed[occupied=false,facing=north,part=head] replace
setblock ~ ~ ~1 minecraft:light_gray_bed[occupied=false,facing=north,part=foot] replace
