...
setblock ~ ~ ~ minecraft:magenta_bed[occupied=false,facing=north,part=foot] replace
setblock ~ ~ ~-1 minecraft:magenta_bed[occupied=false,facing=north,part=head] replace
