...
setblock ~ ~ ~ minecraft:magenta_bed[occupied=false,facing=west,part=head] replace
setblock ~1 ~ ~ minecraft:magenta_bed[occupied=false,facing=west,part=foot] replace
