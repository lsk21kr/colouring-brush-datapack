...
setblock ~ ~ ~ minecraft:orange_bed[occupied=false,facing=west,part=foot] replace
setblock ~-1 ~ ~ minecraft:orange_bed[occupied=false,facing=west,part=head] replace
