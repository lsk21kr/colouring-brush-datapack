...
setblock ~ ~ ~ minecraft:purple_bed[occupied=false,facing=north,part=head] replace
setblock ~ ~ ~1 minecraft:purple_bed[occupied=false,facing=north,part=foot] replace
