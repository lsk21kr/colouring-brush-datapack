...
setblock ~ ~ ~ minecraft:purple_bed[occupied=false,facing=south,part=head] replace
setblock ~ ~ ~-1 minecraft:purple_bed[occupied=false,facing=south,part=foot] replace
